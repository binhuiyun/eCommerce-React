    ...
    return (
      <div className="w-screen h-screen flex flex-col">
        <header className='w-full mx-auto p-2 flex justify-between bg-black'>
          ...
          <div className="sm:flex w-1/3 items-center bg-white px-1 rounded-sm overflow-hidden inset-0">
              ...
              <div className="min-w-sm max-w-xl w-screen">
                <form className="bg-white shadow-lg rounded px-10 pt-6 pb-8 mb-4">
                  ...
                  <div className="mt-6 mb-4">
                    <label className="block text-gray-500 text-sm mb-2" for="email">
                      Email
                    </label>
                    <input className="appearance-none border rounded w-full py-4 px-3 text-black leading-tight focus:outline-none focus:shadow-outline" id="email" type="text" placeholder="you@example.com" />
                  </div>
                  <div className="mb-2">
                    <label className="block text-gray-500 text-sm mb-2" for="password">
                      Password
                    </label>
                    <input className="appearance-none border border-red-500 rounded w-full py-4 px-3 text-black mb-3 leading-tight focus:outline-none focus:shadow-outline" id="password" type="password" placeholder="•••••••••••••••••••"/>
                    <p className="text-red-500 text-xs italic">Please enter your password.</p>
                  </div>
                  <div className="mb-4">
                    <button className="flex w-full text-sm bg-[#5048e5] hover:bg-gray-500 text-white justify-center items-center py-3 rounded focus:outline-none focus:shadow-outline" type="button">
                        Sign In
                    </button>
                  </div>
